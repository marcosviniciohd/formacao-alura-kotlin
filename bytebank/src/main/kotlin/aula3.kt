fun main() {
    ...
    conta1.numero = 1006
    conta1.setSaldo(00.0)

    val conta2 = Conta()
    conta2.titular = "Daniela Oliveira"
    conta2.numero = 1007
    conta2.setSaldo(00.0)

    conta1.deposita(100.0)
    conta2.deposita(200.0)
    conta1.deposita(0.0)
    println("Saldo da conta ${conta1.numero}, é de: ${conta1.getSaldo()} reais")
    println("Saldo da conta ${conta2.numero}, é de: ${conta2.getSaldo()} reais")
